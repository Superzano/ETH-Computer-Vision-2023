...
def UpdateReconstructionState(new_points3D, corrs, points3D, images):
  ...
  for image_name in corrs:
    interval_start, interval_end = corrs[image_name]['interval']
    images[image_name].Add3DCorrs(corrs[image_name]['points2D'], list(range(interval_start + offset, interval_end + offset)))
